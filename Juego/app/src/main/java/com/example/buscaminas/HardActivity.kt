...
import com.example.buscaminas.R.id.gridLayoutHard
import com.example.buscaminas.logic.Logic

class HardActivity : AppCompatActivity(){


        private val BOARD_SIZE_COLUMNS =15  // Definir el tamaño del tablero columnas
        private val BOARD_SIZE_ROWS = 15  // Definir el tamaño del tablero filas
        private val MINES_COUNT = 35 // Definir la cantidad de minas del tablero
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridLayout: GridLayout = findViewById(gridLayoutHard)
    ...
    private fun createCellButton(row: Int, col: Int, gridLayout: GridLayout) {
        val button = Button(this).apply {
            ...
            setBackgroundColor(ContextCompat.getColor(this@HardActivity, R.color.green)) // Color inicial
        }

        // Configuración de LayoutParams para cada botón
        val params = GridLayout.LayoutParams().apply {
            width = 3 // Usar ancho fijo
            height = 3 // Usar alto fijo
            ...
            for (col in 0 until BOARD_SIZE_ROWS) {
                ...
                if (cell.isRevealed) {
                    if (cell.hasMine) {
                        ...
                        button.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14f) // Ajustar tamaño de texto
