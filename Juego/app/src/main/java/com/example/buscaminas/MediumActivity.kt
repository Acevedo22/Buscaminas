...
import com.example.buscaminas.R.id.gridLayoutMedium
import com.example.buscaminas.logic.Logic


class MediumActivity : AppCompatActivity() {

    private val BOARD_SIZE_COLUMNS = 12  // Definir el tamaño del tablero columnas
    private val BOARD_SIZE_ROWS = 12  // Definir el tamaño del tablero filas
    private val MINES_COUNT = 20 // Definir la cantidad de minas del tablero
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridLayout: GridLayout = findViewById(gridLayoutMedium)
    ...
    private fun createCellButton(row: Int, col: Int, gridLayout: GridLayout) {
        val button = Button(this).apply {
            ...
            setBackgroundColor(ContextCompat.getColor(this@MediumActivity, R.color.green)) // Color inicial
        }

        // Configuración de LayoutParams para cada botón
        val params = GridLayout.LayoutParams().apply {
            width = 70 // Usar ancho fijo
            height = 70 // Usar alto fijo
            button.setPadding(10, 10, 10, 10)
            setMargins(2, 2, 2, 2) // Márgenes entre botones
            ...
            for (col in 0 until BOARD_SIZE_ROWS) {
                ...
                if (cell.isRevealed) {
                    if (cell.hasMine) {
                        ...
                        button.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18f) // Ajustar tamaño de texto
                        button.gravity = Gravity.CENTER // Centrar texto
                    }
